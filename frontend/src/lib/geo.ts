...
export const t = {
  pt: {
    ...
    // SocialProof
    socialTitle: "Em números",
    socialMetric1: "marcas",
    socialMetric1d: "já cadastradas na plataforma",
    socialMetric2: "checks",
    socialMetric2d: "de conformidade realizados",
    socialMetric3: "é o tempo médio de análise por imagem",
    socialMetric4: "dimensões",
    socialMetric4d: "analisadas em cada verificação",
  ...
  en: {
    ...
    socialMetric1d: "checked per compliance scan",
    socialMetric2: "seconds",
    socialMetric2d: "average analysis time per image",
    socialMetric3: "cheaper than enterprise brand compliance tools",
